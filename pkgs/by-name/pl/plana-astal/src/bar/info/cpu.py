...
parser = argparse.ArgumentParser(description='CPU info')
parser.add_argument('-d', '--device', action='store_true', help='fetch all CPUs')
parser.add_argument('-m', '--monitor', type=str, help='CPU device to be monitored')
