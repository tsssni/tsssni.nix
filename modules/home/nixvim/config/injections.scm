...
;; =============================================================================
;; ZELLIJ CONFIG NESTED ATTRSET
;; Handles: zellij = { extraConfig = ... }
;; =============================================================================
(binding
  attrpath: (attrpath (identifier) @_path)
  expression: (attrset_expression (binding_set (binding
    ...
    (#any-of? @_nested "extraConfig" "layouts")
  )))
  (#eq? @_path "zellij")
  (#set! injection.language "kdl"))

;; =============================================================================
;; ZELLIJ CONFIG DOT NOTATION
;; Handles: zellij.extraConfig = ...
;; =============================================================================
(binding
  attrpath: (attrpath (identifier) @ns (identifier) @name)
  ...
  (#eq? @ns "zellij")
  (#any-of? @name "extraConfig" "layouts")
  (#set! injection.language "kdl"))

;; =============================================================================
;; NUSHELL INLINE
;; Matches: mkNushellInline ''...''
;; =============================================================================
(apply_expression
  function: (_) @_func
  argument: [
